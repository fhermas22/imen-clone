...
import CertificationProcessHero from "../../assets/images/illustrations/hero/certification-process-hero.svg";
{/*== Data Imports  == */}
import { certificationInfo } from "../../datas/certificationInfo.js";
    ...
    return (
        <main>
            ...
            <Hero
                ...
                imgSrc={CertificationProcessHero}
            ...
            <section id="section2" className="w-full flex flex-col items-center justify-center gap-2 py-8 px-3 md:px-8 lg:py-14 lg:px-[10vw] xl:gap-2 xl:px-[22vw]">
                {certificationInfo.map(info => (
                    <RichTextBlock
                        ...
                        hasTopBorder={false}
                        hasBottomBorder={info.id !== certificationInfo.length}
                        paddingY="pt-8 pb-0"
                    />
                ))}
            </section>
