...
import ComputerMaintenanceIllustration from "../assets/images/illustrations/continuing.education/computer-maintenance.jpg";
...
export const trainingList = [
  // Long-term Trainings
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Data Scientist ; Data Engineer ; Ingénieur en Intelligence Artificielle ; Analyste Big Data ; Consultant en transformation digitale ; Développeur en Machine Learning, etc.",
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Développeur web ; Développeur d'applications mobiles; Développeur logiciel ; Ingénieur DevOps; Ingénieur système et réseaux ; Analyste programmeur; Consultant en technologie, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable", 
      "Clé USB ou disque dur externe", 
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Analyste en cybersécurité ; Ingénieur en sécurité informatique ; Responsable de la sécurité des systèmes d'information (RSSI) ; Pentester (testeur d'intrusion) ; Consultant en sécurité informatique ; Auditeur en sécurité informatique ; Cryptographe, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable", 
      "Clé USB ou disque dur externe", 
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Analyste SOC (Security Operations Center) ; Ingénieur en sécurité informatique ; Enquêteur numérique ; Responsable de la sécurité des systèmes d'information (RSSI), etc.",
    target_audience: null,
    materials: [
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Technicien de maintenance informatique ; Technicien réseau ; Administrateur système junior ; Technicien support informatique ; Responsable technique en centre de service ; Installateur de matériel informatique, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable",
      "Clé USB ou disque dur externe",
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Développeur web ; Développeur mobile ; Intégrateur web ; Designer UX/UI ; Développeur full-stack ; Chef de projet web, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable",
      "Clé USB ou disque dur externe",
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Motion Designer ; Animateur ; Directeur Artistique ; Concepteur 3D; Graphiste Multimédia ; Vidéaste ; Designer d'Interface Animée, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable", 
      "Clé USB ou disque dur externe", 
  ...
  },
  {
    ...
    goals: null,
    openings: "En choisissant ce parcours de formation, vous pouvez exercer plusieurs métiers dont entre autres : Designer UI/UX ; UX Researcher ; Product Designer ; Consultant en Design ; Responsable de la conception, etc.",
    target_audience: null,
    materials: [
      "Ordinateur portable",
      "Clé USB ou disque dur externe",
  ...
  // Continuing Education Trainings
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Créer des pages web statiques et dynamiques; Comprendre les bases de la création de sites web responsifs, adaptés aux différents types d’appareils; Utiliser des outils de développement web pour tester et déboguer leur code; Appliquer les principes de base du développement front-end et être initiés au développement back-end, etc.",
  ...
  },
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Réaliser des analyses de données simples et interpréter les résultats pour répondre à des problématiques spécifiques ; Utiliser des outils de visualisation de données pour créer des graphiques et des tableaux de bord ; Contribuer à des projets d'analyse de données dans des secteurs variés (marketing, finance, RH, etc.).",
  ...
  },
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Diagnostiquer et réparer des pannes matérielles courantes ; Installer et configurer des systèmes d'exploitation et logiciels ; Assurer l'entretien préventif d'un parc informatique ; Gérer les réseaux locaux de base et la sécurité des postes de travail.",
  ...
  },
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Réaliser des montages vidéo simples pour des projets personnels ou professionnels. ; Utiliser un logiciel de montage pour manipuler les séquences vidéo, audio et visuelles. ; Appliquer des effets visuels de base et ajouter une bande sonore adaptée. ; Exporter des vidéos optimisées pour divers supports (réseaux sociaux, plateformes de streaming, présentations).",
  ...
  },
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Concevoir des supports graphiques simples et professionnels ; Utiliser les outils et fonctionnalités de base des logiciels de graphisme ; Créer des visuels attrayants pour des applications variées (print, web, réseaux sociaux) ; Savoir adapter les créations graphiques aux besoins spécifiques de chaque projet.",
  ...
  },
  {
    ...
    openings: "À l’issue de la formation, les participants seront en mesure de : Concevoir des maquettes de sites web esthétiques et fonctionnelles ; Utiliser les outils de design pour créer des interfaces adaptées aux besoins des utilisateurs ; Appliquer les principes d’ergonomie pour améliorer l’expérience utilisateur ; Savoir collaborer avec des développeurs pour la mise en œuvre des designs créés.",
